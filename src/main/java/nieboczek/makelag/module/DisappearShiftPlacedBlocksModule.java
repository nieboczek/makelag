...
public class DisappearShiftPlacedBlocksModule extends NotRunnableModule {
    ...
    public Key<Integer> timerLength = configKey(Key.notNegativeInt("timerLengthMs"));
    public Key<Integer> timerLengthDelta = configKey(Key.notNegativeInt("timerLengthDeltaMs"));
